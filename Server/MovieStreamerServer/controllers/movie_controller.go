...
func GetRankings(c *gin.Context) ([]models.Ranking, error) {
	...
	var rankingCollection *mongo.Collection = databases.OpenCollection("rankings", databases.Client)
...
func GetGenres() gin.HandlerFunc {
	return func(c *gin.Context) {
		...
		var genreCollection *mongo.Collection = databases.OpenCollection("genres", databases.Client)
